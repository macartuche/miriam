 ...
 * @author macbookpro
 */
public class ClientesJpaController1 implements Serializable {

    public ClientesJpaController1(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(Clientes clientes) {
        ...
        try {
            ...
            for (Factura facturaListFactura : clientes.getFacturaList()) {
                Clientes oldIdclienteOfFacturaListFactura = facturaListFactura.getIdcliente();
                facturaListFactura.setIdcliente(clientes);
        ...
        try {
            ...
            for (Factura facturaListNewFactura : facturaListNew) {
                if (!facturaListOld.contains(facturaListNewFactura)) {
                    Clientes oldIdclienteOfFacturaListNewFactura = facturaListNewFactura.getIdcliente();
                    facturaListNewFactura.setIdcliente(clientes);
                    facturaListNewFactura = em.merge(facturaListNewFactura);
                    if (oldIdclienteOfFacturaListNewFactura != null && !oldIdclienteOfFacturaListNewFactura.equals(clientes)) {
    ...
    public void destroy(Long id) throws NonexistentEntityException {
        ...
        try {
            ...
            List<Factura> facturaList = clientes.getFacturaList();
